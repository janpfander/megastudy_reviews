...
#| fig-cap: Distribtions of reviewer scores (weighted averages of the different rating categories) by content label. Each dot corresponds to a review. Lines with dot in the middle (above the boxplots) represent the specific means of the respective content labels, and their 95% CIs.
